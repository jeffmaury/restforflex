...
package com.jeffmaury.restforflex.mx.messaging.channels
{
 ...
 */
public class RestDirectHTTPChannel extends Channel
{
    /**
    *  Constructs an instance of a DirectHTTPChannel.
    *  The parameters are not used.
    */
    public function RestDirectHTTPChannel(id:String, uri:String="")
    {
        super(id, uri);
        if (uri.length > 0)
		{
    ...
    {
        return new RestDirectHTTPMessageResponder(agent, message, this, new URLLoader());
    }
    ...
    {
        var httpMsgResp:RestDirectHTTPMessageResponder = RestDirectHTTPMessageResponder(msgResp);
...
import mx.messaging.MessageAgent;
import mx.messaging.MessageResponder;
import com.jeffmaury.restforflex.mx.messaging.channels.RestDirectHTTPChannel;
import mx.messaging.messages.AcknowledgeMessage;
import mx.messaging.messages.HTTPRequestMessage;
import mx.messaging.messages.ErrorMessage;
import mx.messaging.messages.IMessage;
 ...
 */
class RestDirectHTTPMessageResponder extends MessageResponder
{
	//--------------------------------------------------------------------------
	//
	// Constructor
     ...
     */
    public function RestDirectHTTPMessageResponder(agent:MessageAgent, msg:IMessage, 
                                        channel:RestDirectHTTPChannel, urlLoader:URLLoader)
    {
    ...
    public function completeHandler(event:Event):void
    {
        ...
        if (ack.headers == null) {
        	ack.headers = new Object();
        }
        ack.headers["StatusCode"] = httpStatus;
        agent.acknowledge(ack, message);
    }
