...
package com.jeffmaury.restforflex.mx.rpc.http
{
 ...
 */
public class RestHTTPService extends AbstractInvoker
{
    //--------------------------------------------------------------------------
    //
    // Constructor
     ...
     */
    public function RestHTTPService(rootURL:String = null, destination:String = null)
    {
        super();
  ...
  <attrib1>MyObj.anotherTest</attrib1></userencoded>");
    ...
    private function getDirectChannelSet():ChannelSet
    {
        if (_directChannelSet == null)
        {
            ...
            dcs.addChannel(new RestDirectHTTPChannel("rest_direct_http_channel"));
